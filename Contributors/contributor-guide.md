...
This plugin makes writing mathematical equations much faster. Instead of typing long commands, you use short shortcuts.

1. In Obsidian, click the gear icon (bottom left) to open **Settings**
2. Click **Community plugins**
3. Turn off **Restricted mode**
4. Click **Browse** and search for **LaTeX Suite**
